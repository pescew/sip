...
func (ps *PatronStatus) Marshal() string {
	...
	msg.WriteString(utils.YorBlank(ps.DenyCharges))
	msg.WriteString(utils.YorBlank(ps.DenyRenewals))
	msg.WriteString(utils.YorBlank(ps.DenyRecalls))
	msg.WriteString(utils.YorBlank(ps.DenyHolds))
	msg.WriteString(utils.YorBlank(ps.CardLost))
	msg.WriteString(utils.YorBlank(ps.TooManyCharged))
	msg.WriteString(utils.YorBlank(ps.TooManyOverdue))
	msg.WriteString(utils.YorBlank(ps.TooManyRenewals))
	msg.WriteString(utils.YorBlank(ps.TooManyClaimsReturned))
	msg.WriteString(utils.YorBlank(ps.TooManyItemsLost))
	msg.WriteString(utils.YorBlank(ps.ExceedsFines))
	msg.WriteString(utils.YorBlank(ps.ExceedsFees))
	msg.WriteString(utils.YorBlank(ps.RecallOverdue))
	msg.WriteString(utils.YorBlank(ps.TooManyBilled))
